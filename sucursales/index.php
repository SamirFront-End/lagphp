...
<body>
    ...
    <section>
        <article class="cards">
            <div class="img-card">
                <img src="../assents/img/lagicons/iconmonstr-shop-8.svg" alt="Buscar vehiculo" class="img-srch">
            </div>
            <div class="body-card">
                <h1 class="p-card">Encontrar Tienda</h1>
            </div>
            <div class="footer-card">
                <h3 class="txt-card">Aqui puede obtener el listado de nuestras tiendas oficiales</h3>
            </div>
        </article>
        <article class="cards">
            <div class="img-card">
                <img src="../assents/img/lagicons/iconmonstr-shop-10.svg" alt="Crear vehiculo" class="img-create">
            </div>
            <div class="body-card">
                <h1 class="p-card">Agregar nueva tienda</h1>
            </div>
            <div  class="footer-card">
                <h3 class="txt-card">Aqui puede agregar nuevas tiendas a nuestra cadena</h3>
            </div>
        </article>
        <article class="cards">
            <div class="img-card">
                <img src="../assents/img/lagicons/iconmonstr-shop-10.svg" alt="Actualizar vehiculo" class="img-updt">
            </div>
            <div class="body-card">
                <h1 class="p-card">Actualizar tienda</h1>
            </div>
            <div class="footer-card">
                <h3 class="txt-card">Aqui puede editar y actualizar la informacion de nuestras tiendas</h3>
            </div>
        </article>
        <article class="cards">
            <div class="img-card">
                <img src="../assents/img/lagicons/iconmonstr-shop-11.svg" alt="Borrar registro" class="img-dlt">
            </div>
            <div class="body-card">
                <h1 class="p-card">Borrar tienda</h1>
            </div>
            <div class="footer-card">
                <h3 class="txt-card">Aqui puede suprimir las tiendas que ya no haran parte de nuestra cadena</h3>
            </div>
        </article>
    </section>
    <footer>
