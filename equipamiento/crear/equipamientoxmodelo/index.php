...
<body>
    ...
    <section>
        <article class="cards">
            <div class="img-card">
                <img src="../../../assents/img/lagicons/car-front-headlamp-svgrepo-com.svg" alt="Buscar vehiculo" class="img-srch">
            </div>
            <div class="body-card">
                <h1 class="p-card">Equipamiento por modelo</h1>
            </div>
            <div class="footer-card">
                <h3 class="txt-card">Aqui puede obtener el listado de equipamientos por cada modelo de automovil</h3>
            </div>
            <a class="a-card" href="consultar/index-consulta.php">
                <div class="btn-card">
        ...
        <article class="cards">
            <div class="img-card">
                <img src="../../../assents/img/lagicons/car-metal-steel-svgrepo-com.svg" alt="Crear vehiculo" class="img-create">
            </div>
            <div class="body-card">
                <h1 class="p-card">Agregar  equipamiento a modelo</h1>
            </div>
            <div  class="footer-card">
                <h3 class="txt-card">Aqui puede configurar el equipamiento que tendra cada modelo de vehiculo</h3>
            </div>
        ...
        <article class="cards">
            <div class="img-card">
                <img src="../../../assents/img/lagicons/car-door-mirror-svgrepo-com.svg" alt="Actualizar vehiculo" class="img-updt">
            </div>
            <div class="body-card">
                <h1 class="p-card">Actualizar equipamiento por mdelo</h1>
            </div>
            <div class="footer-card">
                <h3 class="txt-card">Aqui puede editar y actualizar los equipamientos para cada modelo de automovil</h3>
            </div>
            <a class="a-card" href="consultar/index-consulta.php">
                <div class="btn-card">
        ...
        <article class="cards">
            <div class="img-card">
                <img src="../../../assents/img/lagicons/back-car-mirror-svgrepo-com.svg" alt="Borrar registro" class="img-dlt">
            </div>
            <div class="body-card">
                <h1 class="p-card">Borrar equipamiento de modelo</h1>
            </div>
            <div class="footer-card">
                <h3 class="txt-card">Aqui puede suprimir los equipamientos de cada vehiculo</h3>
            </div>
    ...
    <section class="sct-list-tipo">
        <div class="title">
            <h1 class="h1-title">
                Lista de equipamientos por serie
            </h1>
        </div>
